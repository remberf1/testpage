...
function App() {
  ...
  return (
    <>
      ...
      <div className="mt-7   md:p-8 md:max-w-6xl mx-auto flex flex-col md:flex-row md:gap-x-12">
        {/* Image Gallery */}
        ...
        <div className="md:w-1/2 mt-8 md:mt-0 flex flex-col justify-center">
          ...
          {/* Price Section */}
          <div className=" flex flex-row justify-between md:flex-col md:mb-6 py-6">
          ...
          <div className="flex flex-col px-6 py-2 sm:flex-row items-stretch sm:items-center gap-4">
            {/* Quantity Selector */}
            ...
            <button
              onClick={addToCart}
              className="bg-orange-400 hover:bg-orange-600 text-black font-semibold px-6 py-3 rounded-md shadow-sm flex items-center justify-center gap-3 w-full sm:w-2/3"
              style={{ boxShadow: '0 4px 10px rgba(249, 115, 22, 0.4)' }} 
            >
              <img src={cartIcon} alt="cart" className="w-5 h-5 text-black fill-current" />
